  ...
  Docs: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "Open Ask Mira in the lower-right corner when online. Ask a study question or request reviewer creation directly in chat. Tell Mira the topic, number of sets, card count and optional destination folder in your message. There is no separate creation form. Imported notes open as an editable chat draft and are only sent when you press Send. Expand drafts to check questions and answers before saving. Generated content can be inaccurate; verify it against your course material. Online chat requests send your question, recent chat context and a study overview through Netlify to Pollinations. The overview includes your saved name, total library counts, up to 10 reviewer summaries, 15 topic names, 15 folder names, current reviewer, goals, activity statistics, earned achievements and five recent quiz results. Full flashcard contents are not included unless you explicitly enable current-reviewer context. The overview is built on submission, not uploaded in the background. On disconnect the assistant hides and requests stop; its open conversation returns when reconnected.",
      },
      {
        title: "Organize your library with Mira",
        text: "While online, ask Mira to create reviewers in a named folder and topic, create folders or topics, move or copy reviewers, rename a reviewer, or change its topic. Review generated cards and choose Save all reviewers, or review an organization plan and choose Apply changes. Missing destination folders and topics are created. Use a full reviewer title and source folder if names repeat. Moves preserve card IDs and learning history; copies start with new IDs. Failed plans leave your saved library unchanged. AI cannot delete your library. Pending plans are not saved across reloads.",
      },
      {
        title: "Voice input",
